...
_DEST CANVAS1&
SCREEN CANVAS1&
IMAGE& = _LOADIMAGE("./resources/images/progress5.png")
...
DO
    ...
    WHILE _MOUSEINPUT
        ...
        mouse_y% = _MOUSEY
        mouse_w% = _MOUSEWHEEL
        mouse_w_up~%% = mouse_w_up~%% OR _MOUSEWHEEL < 0
        mouse_w_down~%% = mouse_w_down~%% OR _MOUSEWHEEL > 0
        mouse_b1%% = mouse_b1%% OR _MOUSEBUTTON(1) ' left
        mouse_b2%% = mouse_b2%% OR _MOUSEBUTTON(2) ' right
        mouse_b3%% = mouse_b3%% OR _MOUSEBUTTON(3) ' middle
    WEND
