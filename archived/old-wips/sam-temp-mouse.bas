...
SUB MOUSE_refresh
    ...
    IF MOUSE.status.b1_down AND NOT MOUSE.status.starting_drag THEN
        PRINT "DRAG: STARTING"
        MOUSE.status.starting_drag = TRUE
        MOUSE.status.stopping_drag = FALSE
        MOUSE.drag_start = MOUSE.new_state.pos
    ELSEIF MOUSE.status.b1_clicked AND MOUSE.status.starting_drag THEN
        PRINT "DRAG: STOPPING"
        MOUSE.status.stopping_drag = TRUE
        MOUSE.status.starting_drag = FALSE
